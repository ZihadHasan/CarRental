...
from H1.models import seller,buyer,car
...
def giveadd(request):
        if request.method == 'POST':
                 ...
                 data = car(car_name=request.POST['car_name'],car_id=request.POST['car_id'],price_per_day=request.POST['price_per_day'],car_img=request.POST['car_img'])
                 data.save()
                 return render(request, 'home.html')
